          ...
          <section class="content__left col-md-8">
            <div class="block">
              ...
              <div class="block__content">
                ...
                <?php
                $per_page = 4; // хранит кол-во записей на одну страницу
                $page = 1;
                if (isset($_GET['page'])) { // если есть переменная page
                    $page = (int) $_GET['page']; // тогда обновляем переменную $page значением $_GET['page']
                }

                $total_count_q = mysqli_query($connection, "SELECT COUNT(id) `total_count` FROM `articles`"); // кол-во статей на всем блоге
                  ...
                  <article class="article">
                    ...
                    <div class="article__info">
                      ...
                      <div class="article__info__meta">
                        ...
                        ?>
                        <small>Категория: <a href="/articles.php?categorie=<?php $art_cat['id']; ?>"><?php echo $art_cat['title'] ?></a></small>
                      </div>
